describe('Test the Articles path', () => {
  ...
  test('Requestor retrieves data for IGN articles API', () => {
  ...
  test('Requestor retrieves data for Hacker News articles API', () => {
    const consulArticles = require("../../helpers/consulArticles");
    const requestor = require('../../services/requestor');
    consulArticles().then(config => {
  ...
  test('Requestor retrieves data for Reddit-all articles API', () => {
    const consulArticles = require("../../helpers/consulArticles");
    const requestor = require('../../services/requestor');
    consulArticles().then(config => {
